###########################################################################
## Makefile generated for component 'Pacemaker_A2'. 
## 
## Makefile     : Pacemaker_A2.mk
## Generated on : Mon Nov 28 13:49:51 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Pacemaker_A2.elf
...
PRODUCT_NAME              = Pacemaker_A2
MAKEFILE                  = Pacemaker_A2.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/keryn/3k04/SFWRENG-3K04-Group6/Pacemaker
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Pacemaker_A2_comp.rsp
CMD_FILE                  = Pacemaker_A2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Pacemaker_A2.elf
...
DEFINES_ = -DMW_SERIAL0_RXBUF_SIZE=46 -DMW_SERIAL0_TXBUF_SIZE=60 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
DEFINES_STANDARD = -DMODEL=Pacemaker_A2 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o MW_SCI.o i2c_api.o MW_I2C.o MW_AnalogInput.o Pacemaker_A2.o Pacemaker_A2_data.o send_params.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Pacemaker_A2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Pacemaker_A2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Pacemaker_A2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Pacemaker_A2_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Pacemaker_A2_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Pacemaker_A2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Pacemaker_A2.o : $(START_DIR)/Pacemaker_A2_ert_rtw/Pacemaker_A2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Pacemaker_A2_data.o : $(START_DIR)/Pacemaker_A2_ert_rtw/Pacemaker_A2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


send_params.o : $(START_DIR)/Pacemaker_A2_ert_rtw/send_params.c
	$(CC) $(CFLAGS) -o "$@" "$<"

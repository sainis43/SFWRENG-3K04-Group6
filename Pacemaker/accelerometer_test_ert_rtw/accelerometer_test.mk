###########################################################################
## Makefile generated for component 'accelerometer_test'. 
## 
## Makefile     : accelerometer_test.mk
## Generated on : Sun Nov 27 21:31:33 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/accelerometer_test.elf
...
PRODUCT_NAME              = accelerometer_test
MAKEFILE                  = accelerometer_test.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/27161/Desktop/SFWRENG-3K04-Group6/Pacemaker
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = accelerometer_test_comp.rsp
CMD_FILE                  = accelerometer_test.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/accelerometer_test.elf
...
DEFINES_STANDARD = -DMODEL=accelerometer_test -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/accelerometer_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/accelerometer_test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/accelerometer_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/accelerometer_test_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/accelerometer_test_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/accelerometer_test_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


accelerometer_test.o : $(START_DIR)/accelerometer_test_ert_rtw/accelerometer_test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


accelerometer_test_data.o : $(START_DIR)/accelerometer_test_ert_rtw/accelerometer_test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


accelerometer_test_tgtconn.o : $(START_DIR)/accelerometer_test_ert_rtw/accelerometer_test_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
